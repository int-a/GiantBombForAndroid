...
import com.app.int_a.giantbombforandroid.main.util.exoplayer.EventLogger;
 ...
 */
public class VideoActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
    ...
    public static final String ACTION_VIEW = "com.google.android.exoplayer.action.VIEW";
    public static final String EXTENSION_EXTRA = "extension";

    public static final String ACTION_VIEW_LIST =
            "com.google.android.exoplayer.action.VIEW_LIST";
    ...
    public void onClick(View view) {
        if (view == retryButton) {
            ...
            if (mappedTrackInfo != null) {
                // TODO: Do I need the track selection feature?
    ...
    private void initializePlayer() {
        ...
        if (needNewPlayer || needRetrySource) {
            ...
            if (ACTION_VIEW.equals(action)) {
                ...
                // Wait... is it a string array or uri array?
